...
class PaintByNumbersGenerator:
    ...
    def generate(self, input_path: str, output_dir: str = "output",
        ...
        if use_region_emphasis:
            ...
            # Build emphasis summary for downstream reporting
        ...
        # Build QBRIX-style assembly sheets (24×24 tiles, 12 segments per page)
    ...
    def _summarize_emphasis(self, subject_region, region_configs, emphasized_colors,
        ...
        """Build a structured summary of the emphasis split for reporting."""
    ...
    def _build_color_ids(self, palette_name: Optional[str], num_colors: int) -> list:
        """Generate QBRIX-style color identifiers for assembly sheets."""
        ...
        # Deterministic fallback: generate human-friendly IDs starting at 2001
        base = 2001
        step = 37  # Produces spaced-out identifiers reminiscent of kit IDs
